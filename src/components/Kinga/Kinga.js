...
const Kinga = (props) => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      setSecondRange(setProgressBar(new Date("2023-06-14T00:00:00.000+02:00"), new Date("2023-08-24T20:00:00.000+02:00"), defaultProgressBarValues));
    });
